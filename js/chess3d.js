...
class ChessTablero3D {
  ...
  // Sólo el tablero de juego real llama esto (ver inicializarTablero3dAjedrez()
  ...
  // técnica que en el Go (ver board3d.js): el tablero de ajedrez siempre
  // mide 8x8, así que a diferencia del Go las esquinas y la altura son
  // constantes, no dependen de ningún tamaño variable.
